                ...
                child: Form(
                    ...
                    child: Column(children: [
                      Text(
                          ...
                          style: TextStyle(fontSize: 18, color: Theme.of(model.rootBuildContext).colorScheme.secondary)),
                      SizedBox(height: 20),
                      TextFormField(
                          validator: (inValue) {
                      ...
                      connector.connectToServer(() {
                        ...
                        connector.validate(_userName, _password, (inStatus) async {
                          ...
                          if (inStatus == "ok") {
                            ...
                            var crendentialsFile = File("${model.docsDir.path}crendentials");
                            await crendentialsFile.writeAsString("$_userName============$_password");
                            // Store userName in model.
                            model.setUserName(_userName);
                            // Hide login dialog.
                            Navigator.of(model.rootBuildContext).pop();
                            // Show greeting on Home screen.
                            model.setGreeting("Welcom to server, $_userName");
                          }
                        });
                      });
                    }
